...
public class ItemCartComponent extends BaseComponent {
    ...
    public CheckoutPage clickProceedToCheckout() {
        ...
        ExtendedWebElement checkoutBtn = findExtendedWebElement(checkoutLocator, WAIT_TIME);
        checkoutBtn.click();
    ...
    public void clickContinueShopping() {
        ...
        ExtendedWebElement continiueBtn = findExtendedWebElement(continueLocator, WAIT_TIME);
        continiueBtn.click();
    }
}
